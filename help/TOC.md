...
+ Introdução ao Analytics {#intro-to-analytics}
   + O que a Adobe Analytics pode fazer por mim? {#what-can-aa-do-for-me}
      ...
      + [Caso de uso do cliente - O depósito doméstico](intro-to-analytics/what-can-aa-do-for-me/the-home-depot-innovates-with-customer-experience-management.md)
      + [Supersessão da Cúpula 2019 - Viagens e Hospitalidade](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-travel.md)
      + [Super Sessão Summit 2019 - Varejo](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-retail.md)
      + [Super Sessão Summit 2019 - Alta tecnologia](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-high-tech.md)
   + Noções básicas do Analytics {#analytics-basics}
      + [Tentar no botão Espaço de trabalho no Reports and Analytics](intro-to-analytics/analytics-basics/try-in-workspace-button.md)
   ...
   + Personalização da interface do usuário {#customizing-the-ui}
      + [Adicionar descrições de Dimension e métricas](intro-to-analytics/customizing-the-ui/adding-dimension-and-metric-descriptions.md)
      ...
      + [Aumentar a segurança no Adobe Analytics](intro-to-analytics/customizing-the-ui/enhancing-security.md)
      ...
      + [Configuração de um projeto Analysis Workspace como sua Landing page](intro-to-analytics/customizing-the-ui/setting-an-analysis-workspace-project-as-your-landing-page.md)
   ...
   + Obtendo ajuda {#getting-help}
      + [Dicas do produto Analysis Workspace](intro-to-analytics/getting-help/in-product-tips.md)
...
+ Analysis Workspace {#analysis-workspace}
   + Analysis Workspace Basics {#analysis-workspace-basics}
      ...
      + [Criando Novos Projetos Analysis Workspace](analysis-workspace/analysis-workspace-basics/creating-new-analysis-workspace-projects.md)
      ...
      + [Usando modelos personalizados para ativar usuários do Novice Analysis Workspace](analysis-workspace/analysis-workspace-basics/using-custom-templates-to-enable-novice-users.md)
      + [Como os dados entram no seu projeto Analysis Workspace](analysis-workspace/analysis-workspace-basics/understanding-how-data-gets-into-your-analysis-workspace-project.md)
      ...
      + [Uso de gerentes de componentes](analysis-workspace/analysis-workspace-basics/using-component-managers.md)
      + [Selecionar um conjunto de relatórios no Analysis Workspace](analysis-workspace/analysis-workspace-basics/selecting-a-report-suite-in-analysis-workspace.md)
   ...
   + Navegação em projetos da Workspace {#navigating-workspace-projects}
      ...
      + [Densidade da visualização no Analysis Workspace](analysis-workspace/navigating-workspace-projects/view-density-in-analysis-workspace.md)
   ...
   + Usando painéis {#using-panels}
      ...
      + [Uso de Filtros suspensos](analysis-workspace/using-panels/using-drop-down-filters.md)
      + [Segmentos de nível de painel](analysis-workspace/using-panels/panel-level-segments.md)
      + [Usar painéis para organizar seus projetos do Analysis Workspace](analysis-workspace/using-panels/using-panels-to-organize-your-analysis-workspace-projects.md)
   ...
   + Criando Tabelas de Forma Livre {#building-freeform-tables}
      ...
      + [Uso do Criador de tabela de forma livre](analysis-workspace/building-freeform-tables/using-the-freeform-table-builder-in-analysis-workspace.md)
      + [Reorganização de linhas estáticas no Analysis Workspace](analysis-workspace/building-freeform-tables/reordering-static-rows-in-analysis-workspace.md)
      + [Uso de Attribution IQ em tabelas de forma livre](analysis-workspace/attribution-iq/using-attribution-iq-in-freeform-tables.md)
      + [Usando o menu de clique com o botão direito no Analysis Workspace](analysis-workspace/building-freeform-tables/using-the-right-click-menu.md)
      + [Continuação do menu de clique com o botão direito do mouse no Analysis Workspace](analysis-workspace/building-freeform-tables/continued-right-click-menu-in-analysis-workspace.md)
      + [Análise de venda cruzada no Analysis Workspace](analysis-workspace/building-freeform-tables/cross-sell-analysis-workspace.md)
      + [Filtros de tabela de forma livre](analysis-workspace/building-freeform-tables/freeform-table-filters.md)
      + [Dimension de separação de tempo no Analysis Workspace](analysis-workspace/building-freeform-tables/time-parting-dimensions-in-analysis-workspace.md)
      + [Totais da tabela de forma livre no Analysis Workspace](analysis-workspace/building-freeform-tables/freeform-table-totals-in-analysis-workspace.md)
   + Visualizações {#visualizations}
      ...
      + [Adicionar linhas de tendência a visualizações de linha](analysis-workspace/visualizations/adding-trendlines-to-line-visualizations.md)
      ...
      + [Visualizações de Número de resumo e Alteração de resumo](analysis-workspace/visualizations/summary-number-and-summary-change-visualizations.md)
      + [Uso Da Função Média Cumulativa Para Aplicar A Suavização De Métrica](analysis-workspace/visualizations/using-the-cumulative-average-function-to-apply-metric-smoothing.md)
      ...
      + [Vinculação ao vivo do Dimension](analysis-workspace/visualizations/dimension-graph-live-linking.md)
   ...
   + Aplicação de segmentos {#applying-segments}
      + [Aplicar segmentos ao seu projeto Analysis Workspace](analysis-workspace/applying-segments/applying-segments-to-your-analysis-workspace-project.md)
      ...
      + [Uso de modelos de Attribution IQ diferentes com segmentos](analysis-workspace/attribution-iq/using-different-attribution-iq-models-with-segments.md)
      + [Uso de Filtros suspensos](analysis-workspace/using-panels/using-drop-down-filters.md)
      + [Segmentos de nível de painel](analysis-workspace/using-panels/panel-level-segments.md)
      + [Melhorias na Zona de Remessa do Segmento](analysis-workspace/using-panels/segment-dropzone-improvements.md)
      + [Uso de segmentos como Dimension no Analysis Workspace](analysis-workspace/applying-segments/using-segments-as-dimensions-in-analysis-workspace.md)
   ...
   + Métricas {#metrics}
      + [Noções básicas sobre métricas básicas de Visitante](analysis-workspace/metrics/understanding-basic-visitor-metrics.md)
   ...
   + Analisando as viagens do cliente {#analyzing-customer-journeys}
      ...
      + [Expandindo na visualização de Fluxo](analysis-workspace/analyzing-customer-journeys/expanding-on-flow-visualization.md)
   ...
   + Preparar e compartilhar projetos {#curate-and-share-projects}
      ...
      + [Programar e baixar projetos](analysis-workspace/curate-and-share-projects/scheduled-downloadable-projects-analysis-workspace.md)
   ...
   + Attribution IQ {#attribution-iq}
      ...
      + [Adicionar comparações lado a lado de Modelos de Attribution IQ](analysis-workspace/attribution-iq/adding-side-by-side-comparisons-of-attribution-iq-models.md)
   ...
   + Análise de coorte {#cohort-analysis}
      ...
      + [Análise de gráfico com tabelas de coorte](analysis-workspace/cohort-analysis/churn-analysis-with-cohort-tables.md)
      + [Análise de coorte usando qualquer Dimension](analysis-workspace/cohort-analysis/cohort-analysis-using-any-dimension.md)
   ...
   + Voice Analytics {#voice-analytics}
      ...
      + [Entenda As Diferenças Entre Dispositivos Com Voz Ativada](analysis-workspace/voice-analytics/understand-differences-across-voice-enabled-devices.md)
...
+ Administração {#administration}
   ...
   + Gerenciamento de dados e RGPD {#data-governance-and-gdpr}
   ...
   + Logs{#logs}
      + [Rastreamento de log de uso para Analysis Workspace](administration/logs/usage-log-tracking-for-analysis-workspace.md)
+ Implementação {#implementation}
   + Conceitos básicos de implementação {#implementation-basics}
      ...
      + [Criação e manutenção de um DSE](implementation/implementation-basics/creating-and-maintaining-an-sdr.md)
      + [Usando uma camada de dados em seu site](implementation/implementation-basics/using-a-data-layer-on-your-site.md)
   + Via Experience Platform Launch {#via-adobe-launch}
      ...
      + [Configuração básica da extensão de inicialização do Analytics](implementation/via-adobe-launch/basic-configuration-of-the-analytics-launch-extension.md)
      ...
      + [Configuração das configurações gerais na extensão Iniciar o Analytics](implementation/via-adobe-launch/configuring-general-settings-in-the-launch-analytics-extension.md)
      ...
      + [Preparando o Experience Platform Launch para sua implementação do Analytics](implementation/via-adobe-launch/preparing-adobe-launch-for-your-analytics-implementation.md)
      ...
      + [Criando regras de Experience Platform Launch para páginas especiais](implementation/via-adobe-launch/creating-launch-rules-for-special-pages.md)
      + [Criando regras de Experience Platform Launch para Eventos bem-sucedidos](implementation/via-adobe-launch/creating-launch-rules-for-success-events.md)
      + [Publicação de bibliotecas de Experience Platform Launch para estágio e produção](implementation/via-adobe-launch/publishing-launch-libraries-to-stage-and-production.md)
   + Uso do JavaScript {#using-javascript}
      ...
      + [Atualização do AppMeasurement quando não estiver usando o Experience Platform Launch](implementation/using-javascript/updating-appmeasurement-when-not-using-adobe-launch.md)
...
+ Componentes {#components}
   + Segmentação {#segmentation}
      ...
      + [Container de segmento](components/segmentation/segment-containers.md)
      ...
      + [Segmentação em contagens de Dimension distintas](components/segmentation/segmentation-on-distinct-dimension-counts.md)
      + [Modelos de Dimension na segmentação](components/segmentation/dimension-models-in-segmentation.md)
   ...
   + Métricas calculadas {#calculated-metrics}
      ...
      + [Uso de Dimension em métricas calculadas](components/calculated-metrics/using-dimensions-in-calculated-metrics.md)
   ...
   + Conjuntos de relatórios virtuais {#virtual-report-suites}
      ...
      + [Start de uma nova visita em qualquer Evento em conjuntos de relatórios virtuais](components/virtual-report-suites/start-a-new-visit-on-any-event-in-virtual-report-suites.md)
   + Activity Map {#activity-map}
      + [Visão geral do Activity Map](components/activity-map/activity-map-overview.md)
      + [Ativação, depuração e personalização do Activity Map Adobe Analytics](components/activity-map/enabling-debugging-and-customizing-the-activity-map.md)
+ Ferramentas adicionais {#additional-tools}
   + Painéis do Analytics {#analytics-dashboards}
      ...
      + [Experiência no aplicativo de painéis do Analytics](additional-tools/analytics-dashboards/adobe-analytics-dashboards-in-app-experience.md)
+ Exportando {#exporting}
   + Na interface do usuário {#from-the-ui}
      + [Exportar para CSV da Analysis Workspace](exporting/from-the-ui/export-to-csv-from-analysis-workspace.md)
   + Data Warehouse {#data-warehouse}
      + [Introdução à Datas Warehouse](exporting/data-warehouse/introduction-to-data-warehouse.md)
   + Feeds de dados {#data-feeds}
      + [Interface do usuário de gerenciamento de feeds de dados](exporting/data-feeds/data-feeds-management-ui.md)
   + Report Builder {#report-builder}
      ...
      + [Uso do Report Builder para saber mais sobre a API do Adobe Analytics](exporting/report-builder/using-report-builder-to-learn-the-adobe-analytics-api.md)
+ Integrações {#integrations}
   ...
   + Audience Manager {#audience-manager}
      ...
      + [Audience Analytics - Integrar AAM segmentos no Analytics](integrations/audience-manager/audience-analytics-integrate-aam-segments-into-analytics.md)
   + Target {#target}
   ...
   + Ad Cloud {#ad-cloud}
      ...
      + [Criar Advertising Cloud Alerts com o Adobe Analytics](integrations/ad-cloud/create-advertising-cloud-alerts-with-adobe-analytics.md)
      ...
      + [Criar Painéis Advertising Cloud](integrations/ad-cloud/create-advertising-cloud-dashboards-with-adobe-analytics.md)
   + Análise ad hoc {#ad-hoc-analytics}
      + [Uso do Conversor de projetos para mover projetos do Ad Hoc Analysis para o Analytics Workspace](integrations/ad-hoc-analytics/using-the-project-converter-to-move-projects-from-ad-hoc-analysis-to-analytics-workspace.md)
   + Power BI {#power-bi}
...
+ Data Science {#data-science}
   ...
   + [Adobe Analytics e Adobe Sensei - Democratizando a ciência de dados para TODOS](data-science/adobe-analytics-and-adobe-sensei-democratizing-data-science-for-all.md)
+ Específico Vertical {#vertical-specific}
   ...
   + Varejo {#retail}
      ...
      + [Adicionar variáveis e Eventos básicos de varejo às regras de lançamento](vertical-specific/retail/adding-basic-retail-variables-and-events-to-launch-rules.md)
      + [Adicionar uma regra de inicialização para o Evento de compra](vertical-specific/retail/adding-a-launch-rule-for-the-purchase-event.md)
      + [Super Sessão Summit 2019 - Varejo](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-retail.md)
+ Media Analytics {#media-analytics}
   + Medição de voz ou áudio {#measuring-voice-or-audio}
      + [Uso do modelo de consumo de áudio no Analysis Workspace](media-analytics/measuring-voice-or-audio/using-the-audio-consumption-template-in-analysis-workspace.md)
+ Análise de aplicativos móveis {#mobile-app-analytics}
   + Implementação {#implementation}
      ...
      + [Inicialização e visualização de medições de ciclo de vida com o SDK do Experience Platform](mobile-app-analytics/implementation/initializing-and-viewing-lifecycle-metrics-with-the-experience-platform-sdk.md)
      + [Ações de rastreamento (links personalizados AKA)](mobile-app-analytics/implementation/tracking-actions-aka-custom-links.md)
      + [Estado de rastreamento (páginas ou telas AKA)](mobile-app-analytics/implementation/tracking-state-aka-pages-or-screens.md)
      + [Implementação em aplicativos iOS Swift](https://docs.adobe.com/content/help/pt-BR/experience-cloud/implementing-in-mobile-ios-swift-apps-with-launch/index.html)
      + [Implementação em aplicativos iOS Objetive-C](https://docs.adobe.com/content/help/pt-BR/experience-cloud/implementing-in-mobile-ios-objective-c-apps-with-launch/index.html)
...
+ APIs {#apis}
   + [Como usar o Analysis Workspace para criar solicitações da API 2.0](apis/using-analysis-workspace-to-build-api-2-requests.md)
   + [Uso do Report Builder para saber mais sobre a API do Adobe Analytics](exporting/report-builder/using-report-builder-to-learn-the-adobe-analytics-api.md)
   + [Usando o Postman para fazer solicitações de API do Adobe Analytics 2.0](apis/using-postman-to-make-adobe-analytics-2-0-api-requests.md)
+ Casos de uso de análise {#analysis-use-cases}
   + [Configurando a Análise de CEP no mercado](analysis-use-cases/setting-up-in-market-zip-code-analysis-use-case.md)
