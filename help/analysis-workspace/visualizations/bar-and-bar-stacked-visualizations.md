...
Neste vídeo, falamos sobre como adicionar e configurar as visualizações de barra, barra empilhada, barra horizontal e barra horizontal empilhada no seu projeto no Analysis Workspace. Embora consideradas básicas, essas visualizações podem ajudar a contar suas histórias de dados e fornecer insights para seus analistas.

>[!VIDEO](https://video.tv.adobe.com/v/334308/?quality=12&learn=on)

Para obter mais informações, consulte a [documentação](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/bar.html?lang=pt-BR).
